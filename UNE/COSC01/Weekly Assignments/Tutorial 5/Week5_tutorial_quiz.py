...
#  Write a program that loops through all the keys in the available dictionary to help determine the total number of items available (e.g. in the given case, there are 3 pens, 5 pencils, 2 erasers, and 10 papers, so your program should output 20). Your program should display a count of the total number
